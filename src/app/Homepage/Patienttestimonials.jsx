...
function Patienttestimonials() {
  ...
  <h1 className='testimonialCardHeading'>Uzair Shaikh</h1>
   <p className='testimonialCardPara'>
   Dr Mahak is very good at her work , I am very much happy with the treatment she has done for me & my mother.She listens first carefully to your problem & concerns and then suggest the best suitable treatment plan & its cost accordingly
   </p>
   <p className='TestimonialCardGoogle'>Google Review</p>
...
<h1 className='testimonialCardHeading'>Riya Nathani</h1>
 <p className='testimonialCardPara'>
 I was not sure if I'll get the treatment as u get at proper clinic but believe me it was way more better n easier..Dr Mahek and her team is amazing..Thank you for being so good 😊 </p>
 <p className='TestimonialCardGoogle'>Google Review</p>
...
<h1 className='testimonialCardHeading'>Rohit Wakhare</h1>
 <p className='testimonialCardPara'>
 Mahak an exceptional dentist who deserves my highest praise! Not only did they skillfully fix my tooth with precision and care, but their warm and friendly demeanor made me feel comfortable throughout the entire process. I'm grateful for their expertise and grateful to have found such a talented professional.Thank you, for restoring my smile and providing an outstanding dental experience!"  </p>
 <p className='TestimonialCardGoogle'>Google Review</p>
